...
export const SEARCH_USERS_SUCCESS = 219
export const SEARCH_USERS_ERROR = 220
export const FETCH_ONLINE_USERS_SUCCESS = 221
export const FETCH_ONLINE_USERS_ERROR = 222
export const START_TYPING_RESPONSE = 223
